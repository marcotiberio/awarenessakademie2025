...
function registerNewsCategoryTaxonomy()
{
    $labels = [
        'name'                       => _x('Categories', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Category', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Categories', 'flynt'),
...
add_action('init', 'Flynt\\CustomTaxonomies\\registerNewsCategoryTaxonomy');
