...
function registerWorkshopPostType()
{
    $labels = [
        'name'                  => _x('Workshops', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Workshop', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Workshops', 'flynt'),
        'name_admin_bar'        => __('Workshops', 'flynt'),
